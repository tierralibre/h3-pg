...
INSERT INTO h3_test_spgist (hex) SELECT h3_to_parent(:hexagon);
INSERT INTO h3_test_spgist (hex) SELECT h3_to_children(:hexagon);
INSERT INTO h3_test_spgist (hex) SELECT h3_to_center_child(:hexagon, 15);
...
INSERT INTO h3_test_spgist (hex) SELECT h3_to_children(h3_to_center_child(:hexagon, 10), 15);
